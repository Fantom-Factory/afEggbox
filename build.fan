...
class Build : BuildPod {
	...
	new make() {
		...
		srcDirs = [`test-spec/`, `test-spec/web/`, `test-spec/web/login/`, `test-spec/utils/`, `test-spec/fanr/`, `fan/`, `fan/web/`, `fan/web/util/`, `fan/web/services/`, `fan/web/pages/`, `fan/web/pages/my/`, `fan/web/components/`, `fan/fanr/`, `fan/fandoc/`, `fan/core/`, `fan/core/entities/`, `fan/core/database/`, `fan/bedframe/`]
		resDirs = [`res/`]
	}
}
