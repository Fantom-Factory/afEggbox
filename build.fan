...
//			"afBson       1.0.0  - 1.0",
		...
		srcDirs = [`test-spec/`, `test-spec/web/`, `test-spec/utils/`, `test-spec/fanr/`, `fan/`, `fan/web/`, `fan/web/services/`, `fan/web/pages/`, `fan/web/pages/user/`, `fan/web/components/`, `fan/fanr/`, `fan/core/`, `fan/core/entities/`, `fan/core/database/`, `fan/bedframe/`]
